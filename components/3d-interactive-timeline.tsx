...
export const Timeline3D: React.FC<Timeline3DProps> = ({
  ...
  return (
    <div
      className={`w-full bg-transparent py-16 px-4 sm:px-6 lg:px-8 overflow-hidden ${textColor} ${className}`}
      ref={containerRef}
    >
            ...
            {events.map((event, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Content card */}
                  <motion.div
                    className={`relative z-10 backdrop-blur-lg rounded-2xl overflow-hidden shadow-xl w-full md:w-[calc(100%-2rem)] ${
                      ...
                      <div className="relative h-48 overflow-hidden">
                        ...
                        {event.category && (
                          <div className="absolute top-4 right-4">
                            <span className={`${accentColor} px-3 py-1 rounded-full text-xs font-semibold tracking-wider uppercase text-gray-900`}>
                              {event.category}
                            </span>
                          </div>
                        )}
